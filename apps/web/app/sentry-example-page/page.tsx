    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://git-max.sentry.io/issues/?project=4509826834825216">Issues Page</a>.
